package com.wowtown.wowtownbackend.common.infra;

import com.wowtown.wowtownbackend.common.interceptor.SubProtocolWebSocketHandlerInterceptor;
...
public class AgentWebSocketHandlerDecoratorFactory implements WebSocketHandlerDecoratorFactory {
  ...
  public WebSocketHandler decorate(WebSocketHandler handler) {
    ...
    proxyFactory.addAdvisor(
        new DefaultIntroductionAdvisor(new SubProtocolWebSocketHandlerInterceptor()));
